...
<body>
    ...
    <div class="container d-flex flex-column justify-content-center align-items-center text-center position-relative" data-aos="zoom-out">
            <img src="assets/img/hero-carousel/csmss_logo.png" class="img-fluid animated">
            <h2>Welcome to <span>CSMSS Placement Hub</span></h2>
            ...
            <div class="container" data-aos="zoom-out">
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-8 col-md-6 content d-flex flex-column justify-content-center order-last order-md-first">
                        <h3>Placement <em>Hub</em> </h3>
                        <p>The campus Placement Hub plays a crucial role in <b> CSMSS Chh.Shahu College Of Engineering Chh.Sambhaji Nagar</b>
                        <br>
                            <br><u>Students</u> :-
                            <br>Mr. Dinesh Uttam Thale (Roll No: CS4128)
                            <br>Mr. Ganesh Kisan Tagad (Roll No: CS4130)
                            <br>Mr. Rahul Ravindra Nrupnarayan (Roll No: CS4165)
                            <br>Mr. Rahul Arunrao Pawar (Roll No: CS4166)
                    ...
                    <div class="tab-pane active show" id="tab-1">
                        <div class="row gy-4">
                            <div class="col-lg-8 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="100">
                                <h3>Objectives</h3>
                                <p class="fst-itali">
                                    Our Placement Hub serves various objectives:
                                </p>
                                <ul>
